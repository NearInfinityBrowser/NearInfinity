...
// --------------------- End Interface ChangeListener ---------------------
  ...
  public int read(byte buffer[], int offset) throws Exception
  {
    ...
    offsetAction = new SectionOffset(buffer, offset + 40, DLG_OFFSET_ACTIONS, infinity.resource.dlg.Action.class);
    addField(offsetAction);
    countAction = new SectionCount(buffer, offset + 44, 4, DLG_NUM_ACTIONS, infinity.resource.dlg.Action.class);
