...
public class LayerManager
{
   ...
   */
  public static boolean getSelectedState(Type type)
  {
   ...
   */
  public static void setSelectedState(Type type, boolean state)
  {
    if (type != null && LayerSelectedState.containsKey(type)) {
  ...
  public LayerManager(AreaViewer viewer)
  {
    this.viewer = viewer;
   ...
   */
  public ItemLayer get(Type type)
  {
    if (type != null) {
   ...
   */
  public ItemLayer findByName(String name)
  {
    if (name != null) {
   ...
   */
  public boolean setProperties(Type type, String name, String longName)
  {
    if (type != null) {
   ...
   */
  public boolean initData(Type type, JCheckBox checkBox, Container target)
  {
    switch (type) {
  ...
  private boolean initActor(JCheckBox checkBox, Container target)
  {
    ...
    if (listEntries == null) return false;
    ...
    checkBox.setEnabled(!layer.isEmpty());
...
//        mapCanvas.add(item);
  ...
  private boolean initWallPoly(JCheckBox checkBox, Container target)
  {
    ...
    layer.addAllToContainer(target);
    checkBox.setEnabled(!layer.isEmpty());
    checkBox.setToolTipText(list.size() + " wall polygons available");
    return true;
  }
