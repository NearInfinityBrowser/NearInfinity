...
public class AbstractVariable extends AbstractStruct implements AddRemovable {
  ...
  public static final String[] TYPE_ARRAY = { "Integer", "Float", "Script name", "Resource reference",
  ...
  public enum Type {
    ...
    public Object getValue(AbstractVariable var) {
      switch (this) {
        case INTEGER:
          return ((IsNumeric) var.getAttribute(VAR_INT, false)).getValue();
        case DOUBLE:
          return ((FloatNumber) var.getAttribute(VAR_DOUBLE, false)).getValue();
        case SCRIPT_NAME:
          return ((IsTextual) var.getAttribute(VAR_SCRIPT_NAME, false)).getText();
        case RESREF:
          return ((IsNumeric) var.getAttribute(VAR_REFERENCE, false)).getValue();
        case STRREF: {
        ...
        case DWORD:
          return ((IsNumeric) var.getAttribute(VAR_DWORD, false)).getLongValue();
      }
  ...
  protected AbstractVariable(AbstractStruct superStruct, ByteBuffer buffer, int offset, int nr) throws Exception {
    super(superStruct, VAR + " " + nr, buffer, offset);
  }

  protected AbstractVariable(AbstractStruct superStruct, String name, ByteBuffer buffer, int offset) throws Exception {
  ...
  public int read(ByteBuffer buffer, int offset) throws Exception {
    ...
    addField(new Bitmap(buffer, offset + 32, 2, VAR_TYPE, TYPE_ARRAY));
  ...
  /**
   * Returns value of the specified type of this variable. If variable have different type, {@code null} is returned.
   *
   * @param type Type of value to get
   * @return Variable value or {@code null}. See documentation for {@link Type} enum values for the concrete returning
   *         type
   */
