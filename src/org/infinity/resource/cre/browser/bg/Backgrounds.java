...
public final class Backgrounds {
  public static final BackgroundInfo BG_WILDERNESS_BG = new BackgroundInfo("Wilderness (BG2)", new Color(0x282f12),
      "bg_wilderness.jpg", new Point(640, 632), EnumSet.complementOf(EnumSet.of(Profile.Game.PST, Profile.Game.PSTEE)));

  public static final BackgroundInfo BG_CAVE_BG = new BackgroundInfo("Cave (BG2)", new Color(0x010101), "bg_cave.jpg",
      new Point(640, 554), EnumSet.complementOf(EnumSet.of(Profile.Game.PST, Profile.Game.PSTEE)));
  ...
  public static final BackgroundInfo BG_CITY_PST = new BackgroundInfo("Sigil city (PST)", new Color(0x494131),
      "pst_city.jpg", new Point(640, 580), EnumSet.of(Profile.Game.PST, Profile.Game.PSTEE));

  public static final BackgroundInfo BG_DUNGEON_PST = new BackgroundInfo("Sigil dungeon (PST)", new Color(0x010101),
      "pst_dungeon.jpg", new Point(640, 480), EnumSet.of(Profile.Game.PST, Profile.Game.PSTEE));
   ...
   * Returns an {@link Image} object of the specified graphics filename.
   *
   * @param c        A class located in the same package as the specified graphics file. The full package name of the
   *                 class will be used to determine the correct path of the graphics file.
   * @param fileName The graphics filename.
   * @return The {@link Image} object, or {@code null} on error.
   */
  ...
  public static class BackgroundInfo {
    ...
    public EnumSet<Profile.Game> getGames() {
      return games;
    }
    ...
    public Image getImage() {
      return hasImage() ? Backgrounds.getImage(imageName) : null;
    }
    ...
    public boolean isAvailable() {
      return (games == null) || games.contains(Profile.getGame());
    }
