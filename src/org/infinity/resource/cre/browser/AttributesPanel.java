...
public class AttributesPanel extends JPanel implements ActionListener {
  ...
  /**
   * Returns the INI file associated with the currently selected creature animation if available, returns {@code null}
   * otherwise.
   */
  ...
  private void init() {
    ...
    tableAnimation = new JTable(tableModel, new DecoderAttributesTableModel.AttributesColumnModel(),
    ...
    tableAnimation.getTableHeader()
        .setDefaultRenderer(new DecoderAttributesTableModel.AttributesHeaderRenderer(tableAnimation));
