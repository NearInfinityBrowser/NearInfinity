...
public class MonsterLayeredDecoder extends SpriteDecoder
{
  ...
  public static final AnimationType ANIMATION_TYPE = AnimationType.MONSTER_LAYERED;
  ...
  protected SeqDef getSequenceDefinition(Sequence seq)
  {
    ...
    switch (seq) {
      case ATTACK:
      case ATTACK_2:
        if (SpriteUtils.isWeaponTwoHanded(SpriteUtils.getEquippedWeapon(getCreResource()), false)) {
          return retVal;
        }
        break;
      case ATTACK_2H:
