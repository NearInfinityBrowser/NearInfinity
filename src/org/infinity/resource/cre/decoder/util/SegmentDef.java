...
public class SegmentDef implements Cloneable {
  ...
  public enum Behavior {
    /**
     * Segment runs from start to end and repeats the process if other segments of the current cycle contain more
     * frames. This is the default if no behavior has been specified.
     */
    REPEAT,
    /**
    ...
    SINGLE,
    /**
     * Segment runs from start to end and continues to provide the last frame if other segments of the current cycle
     * contain more frames.
     */
    FREEZE,
    /**
    ...
    static {
      ...
      OPPOSITES_MAP.put(SINGLE, REVERSE_SINGLE);
      OPPOSITES_MAP.put(FREEZE, REVERSE_FREEZE);
      OPPOSITES_MAP.put(CUT, REVERSE_CUT);
      OPPOSITES_MAP.put(REVERSE_REPEAT, REPEAT);
      OPPOSITES_MAP.put(REVERSE_SINGLE, SINGLE);
      OPPOSITES_MAP.put(REVERSE_FREEZE, FREEZE);
      OPPOSITES_MAP.put(REVERSE_CUT, CUT);
    }
    ...
    public static Behavior getOpposite(Behavior b) {
      return OPPOSITES_MAP.getOrDefault(b, REVERSE_REPEAT);
    }
  }
  ...
  /**
   * Determines the behavior variant specified by the given BAM animation suffix. If an exclamation mark is found it
   * returns the opposite of the default behavior. Otherwise it will return the default behavior.
   */
  ...
  /**
   * Determines the behavior variant specified by the given BAM animation suffix. If an exclamation mark is found it
   * returns the opposite of the specified behavior. Otherwise it will return the specified behavior.
   */
  ...
  /**
   * Creates a new independent segment definition with the specified parameters. Behavior is assumed to be
   * {@link Behavior#REPEAT}. Composite object is initialized with {@link AlphaComposite#SrcOver}.
   *
  ...
  /**
   * Creates a new independent segment definition with the specified parameters. Composite object is initialized with
   ...
   * Behavior is assumed to be {@link Behavior#REPEAT}. Composite object is initialized with
   * {@link AlphaComposite#SrcOver}.
   *
  ...
  /**
   * Creates a new segment definition with the attributes defined in the specified {@code SegmentDef} argument. Parent
  ...
  public CycleDef getParent() {
    return parent;
  }

  /** Updates the parent link. Should not be called directly. */
  void setParent(CycleDef parent) {
    this.parent = parent;
  }
  ...
  public String toString() {
    return "entry=" + bamEntry.toString() + ", cycle=" + cycleIndex + ", type=" + type.toString() + ", behavior="
        + behavior.toString() + ", numFrames=" + numFrames + ", curFrame=" + curFrame;
  }

  @Override
  public int hashCode() {
    return Objects.hash(bamEntry, behavior, curFrame, cycleIndex, numFrames, type);
  }
  ...
  public boolean equals(Object obj) {
    ...
    SegmentDef other = (SegmentDef) obj;
    return Objects.equals(bamEntry, other.bamEntry) && behavior == other.behavior && curFrame == other.curFrame
        && cycleIndex == other.cycleIndex && numFrames == other.numFrames && type == other.type;
  }
