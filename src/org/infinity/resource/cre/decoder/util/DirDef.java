...
public class DirDef implements Cloneable {
  ...
  /**
   * Creates a new direction definition with the attributes defined in the specified {@code DirDef} argument. Parent
  ...
  /**
   * Advances the animation by one frame for all segment definitions in the associated cycle according to their
   * respective behavior.
   */
  public void advance() {
    cycle.advance();
  ...
  @Override
  public int hashCode() {
    return Objects.hash(cycle, direction, mirrored);
  }
  ...
  public boolean equals(Object obj) {
    ...
    DirDef other = (DirDef) obj;
    return Objects.equals(cycle, other.cycle) && direction == other.direction && mirrored == other.mirrored;
  }
}
