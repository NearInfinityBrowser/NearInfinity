...
/**
 * Creature animation decoder for processing type 1000 (multi_monster) animations consisting of 9 quadrants. Note: This
 * type can be incorrectly labeled as "multi_new" in INI files. Available ranges: [1200,12ff], [1400,1fff]
 */
public class MonsterMultiDecoder extends QuadrantsBaseDecoder {
  ...
  public static final DecoderAttribute KEY_DOUBLE_BLIT = DecoderAttribute.with("double_blit",
      DecoderAttribute.DataType.BOOLEAN);
  public static final DecoderAttribute KEY_PALETTE_1 = DecoderAttribute.with("palette1",
      DecoderAttribute.DataType.STRING);
  public static final DecoderAttribute KEY_PALETTE_2 = DecoderAttribute.with("palette2",
      DecoderAttribute.DataType.STRING);
  public static final DecoderAttribute KEY_PALETTE_3 = DecoderAttribute.with("palette3",
      DecoderAttribute.DataType.STRING);
  public static final DecoderAttribute KEY_PALETTE_4 = DecoderAttribute.with("palette4",
      DecoderAttribute.DataType.STRING);
  ...
  static {
    ...
    SUFFIX_MAP_UNSPLIT.put(Sequence.WALK, Couple.with("G1_", 0));
    SUFFIX_MAP_UNSPLIT.put(Sequence.STANCE, Couple.with("G2_", 0));
    SUFFIX_MAP_UNSPLIT.put(Sequence.SPELL, SUFFIX_MAP_UNSPLIT.get(Sequence.STANCE));
    SUFFIX_MAP_UNSPLIT.put(Sequence.STAND, Couple.with("G2_", 9)); // engine appears to use STANCE sequence instead
    // SUFFIX_MAP_UNSPLIT.put(Sequence.STAND, SUFFIX_MAP_UNSPLIT.get(Sequence.STANCE));
    SUFFIX_MAP_UNSPLIT.put(Sequence.ATTACK, Couple.with("G3_", 0));
    // SUFFIX_MAP_UNSPLIT.put(Sequence.ATTACK_2, SUFFIX_MAP_UNSPLIT.get(Sequence.ATTACK)); // apparently unused by the engine
    // SUFFIX_MAP_UNSPLIT.put(Sequence.ATTACK_3, SUFFIX_MAP_UNSPLIT.get(Sequence.ATTACK)); // apparently unused by the engine
    SUFFIX_MAP_UNSPLIT.put(Sequence.GET_HIT, Couple.with("G4_", 0));
    SUFFIX_MAP_UNSPLIT.put(Sequence.DIE, Couple.with("G4_", 9));
    SUFFIX_MAP_UNSPLIT.put(Sequence.SLEEP, SUFFIX_MAP_UNSPLIT.get(Sequence.DIE));
    SUFFIX_MAP_UNSPLIT.put(Sequence.GET_UP, Couple.with("!G4_", 9));
    SUFFIX_MAP_UNSPLIT.put(Sequence.TWITCH, Couple.with("G4_", 18));
    SUFFIX_MAP_UNSPLIT.put(Sequence.CAST, Couple.with("G5_", 9));
    SUFFIX_MAP_UNSPLIT.put(Sequence.SHOOT, SUFFIX_MAP_UNSPLIT.get(Sequence.CAST));
    ...
    SUFFIX_MAP_SPLIT.put(Sequence.WALK, Couple.with("1_0+", 0));
    SUFFIX_MAP_SPLIT.put(Sequence.STANCE, Couple.with("2_0+", 0));
    SUFFIX_MAP_SPLIT.put(Sequence.SPELL, SUFFIX_MAP_SPLIT.get(Sequence.STANCE));
    SUFFIX_MAP_SPLIT.put(Sequence.STAND, Couple.with("2_0+", 9)); // engine appears to use STANCE sequence instead
    // SUFFIX_MAP_SPLIT.put(Sequence.STAND, SUFFIX_MAP_SPLIT.get(Sequence.STANCE));
    SUFFIX_MAP_SPLIT.put(Sequence.ATTACK, Couple.with("3_0+", 0));
    // SUFFIX_MAP_SPLIT.put(Sequence.ATTACK_2, SUFFIX_MAP_SPLIT.get(Sequence.ATTACK)); // apparently unused by the engine
    // SUFFIX_MAP_SPLIT.put(Sequence.ATTACK_3, SUFFIX_MAP_SPLIT.get(Sequence.ATTACK)); // apparently unused by the engine
    SUFFIX_MAP_SPLIT.put(Sequence.GET_HIT, Couple.with("4_0+", 0));
    SUFFIX_MAP_SPLIT.put(Sequence.DIE, Couple.with("4_1+", 9));
    SUFFIX_MAP_SPLIT.put(Sequence.SLEEP, SUFFIX_MAP_SPLIT.get(Sequence.DIE));
    SUFFIX_MAP_SPLIT.put(Sequence.GET_UP, Couple.with("!4_1+", 9));
    SUFFIX_MAP_SPLIT.put(Sequence.TWITCH, Couple.with("4_2+", 18));
    SUFFIX_MAP_SPLIT.put(Sequence.CAST, Couple.with("5_1+", 9));
    SUFFIX_MAP_SPLIT.put(Sequence.SHOOT, SUFFIX_MAP_SPLIT.get(Sequence.CAST));
  }
    ...
    for (final HashMap.Entry<Sequence, Couple<String, Integer>> entry : getSuffixMap().entrySet()) {
      for (int i = 0; i < getQuadrants(); i++) {
        for (int j = 0; j < SeqDef.DIR_FULL_W.length; j++) {
          String suffix = entry.getValue().getValue0().replace("_", Integer.toString(i + 1)).replace("+",
              Integer.toString(j));
  ...
  protected SeqDef getSequenceDefinition(Sequence seq) {
    ...
    if (getSuffixMap().containsKey(seq)) {
      ...
      int cycleBase = getSuffixMap().get(seq).getValue1();
      ...
      for (final Direction dir : SeqDef.DIR_FULL_W) {
        ...
        for (int seg = 0; seg < getQuadrants(); seg++) {
          String suffix = suffixBase.replace("_", Integer.toString(seg + 1)).replace("+",
              Integer.toString(dir.getValue()));
      ...
      // Structure:
      // xxxx1[1-9]0[0-8]: [0-8]
      // xxxx1100: 0, xxxx1200: 0, xxxx1300: 0, xxxx1400: 0, xxxx1500: 0, xxxx1600: 0, xxxx1700: 0, xxxx1800: 0,
      // xxxx1900: 0
      // xxxx1101: 1, xxxx1201: 1, xxxx1301: 1, xxxx1401: 1, xxxx1501: 1, xxxx1601: 1, xxxx1701: 1, xxxx1801: 1,
      // xxxx1901: 1
      // xxxx1102: 2, xxxx1202: 2, xxxx1302: 2, xxxx1402: 2, xxxx1502: 2, xxxx1602: 2, xxxx1702: 2, xxxx1802: 2,
      // xxxx1902: 2
      // xxxx1103: 3, xxxx1203: 3, xxxx1303: 3, xxxx1403: 3, xxxx1503: 3, xxxx1603: 3, xxxx1703: 3, xxxx1803: 3,
      // xxxx1903: 3
      // xxxx1104: 4, xxxx1204: 4, xxxx1304: 4, xxxx1404: 4, xxxx1504: 4, xxxx1604: 4, xxxx1704: 4, xxxx1804: 4,
      // xxxx1904: 4
      // xxxx1105: 5, xxxx1205: 5, xxxx1305: 5, xxxx1405: 5, xxxx1505: 5, xxxx1605: 5, xxxx1705: 5, xxxx1805: 5,
      // xxxx1905: 5
      // xxxx1106: 6, xxxx1206: 6, xxxx1306: 6, xxxx1406: 6, xxxx1506: 6, xxxx1606: 6, xxxx1706: 6, xxxx1806: 6,
      // xxxx1906: 6
      // xxxx1107: 7, xxxx1207: 7, xxxx1307: 7, xxxx1407: 7, xxxx1507: 7, xxxx1607: 7, xxxx1707: 7, xxxx1807: 7,
      // xxxx1907: 7
      // xxxx1108: 8, xxxx1208: 8, xxxx1308: 8, xxxx1408: 8, xxxx1508: 8, xxxx1608: 8, xxxx1708: 8, xxxx1808: 8,
      // xxxx1908: 8
    }
