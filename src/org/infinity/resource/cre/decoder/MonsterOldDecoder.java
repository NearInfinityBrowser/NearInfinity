...
/**
 * Creature animation decoder for processing type 7000 (monster_old) animations.
...
public class MonsterOldDecoder extends SpriteDecoder
{
  ...
  public static final AnimationType ANIMATION_TYPE = AnimationType.MONSTER_OLD;
  ...
  private static final HashMap<Sequence, Couple<String, Integer>> suffixMap = new HashMap<Sequence, Couple<String, Integer>>() {{
    ...
    put(Sequence.ATTACK_3, Couple.with("G2", 16));
  }};
