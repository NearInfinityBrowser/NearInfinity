...
public abstract class QuadrantsBaseDecoder extends SpriteDecoder {
  public static final DecoderAttribute KEY_QUADRANTS = DecoderAttribute.with("quadrants",
  ...
  public int getQuadrants() {
    return getAttribute(KEY_QUADRANTS);
  }

  protected void setQuadrants(int v) {
    setAttribute(KEY_QUADRANTS, v);
  }
