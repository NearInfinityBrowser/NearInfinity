...
public abstract class QuadrantsBaseDecoder extends SpriteDecoder
{
  ...
  public QuadrantsBaseDecoder(AnimationType type, int animationId, IniMap ini) throws Exception
  {
    super(type, animationId, ini);
  }

  protected QuadrantsBaseDecoder(AnimationType type, CreResource cre) throws Exception
  {
    super(type, cre);
  }
