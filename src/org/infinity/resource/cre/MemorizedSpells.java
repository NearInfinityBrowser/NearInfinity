...
public final class MemorizedSpells extends AbstractStruct implements AddRemovable {
  ...
  private static final String[] MEM_ARRAY = { "Spell already cast", "Spell memorized", "Spell disabled" };
  ...
  public int read(ByteBuffer buffer, int offset) throws Exception {
    ...
    addField(new Flag(buffer, offset + 8, 2, CRE_MEMORIZED_MEMORIZATION, MEM_ARRAY));
