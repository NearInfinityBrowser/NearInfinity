...
public final class Item extends AbstractStruct implements AddRemovable {
  ...
  public static final String[] FLAGS_ARRAY = { "No flags set", "Identified", "Not stealable", "Stolen", "Undroppable" };
  ...
  public int read(ByteBuffer buffer, int offset) throws Exception {
    ...
    addField(new Flag(buffer, offset + 16, 4, ARE_ITEM_FLAGS, FLAGS_ARRAY));
    return offset + 20;
  }
}
