...
public final class ViewerContainer extends JPanel {
  ...
  private JPanel makeFieldPanel(Container container) {
    ...
    ViewerUtil.addLabelFieldPair(fieldPanel, container.getAttribute(Container.ARE_CONTAINER_NAME), gbl, gbc, true);
    ViewerUtil.addLabelFieldPair(fieldPanel, container.getAttribute(Container.ARE_CONTAINER_TYPE), gbl, gbc, true);
    ...
    ViewerUtil.addLabelFieldPair(fieldPanel, container.getAttribute(Container.ARE_CONTAINER_LOCK_DIFFICULTY), gbl, gbc,
        true);
    ...
    ViewerUtil.addLabelFieldPair(fieldPanel, container.getAttribute(Container.ARE_CONTAINER_TRAP_REMOVAL_DIFFICULTY),
        gbl, gbc, true);
    ViewerUtil.addLabelFieldPair(fieldPanel, container.getAttribute(Container.ARE_CONTAINER_SCRIPT_TRAP), gbl, gbc,
        true);
    ...
    JComponent check2 = ViewerUtil.makeCheckLabel(container.getAttribute(Container.ARE_CONTAINER_TRAPPED), "Yes (1)");
