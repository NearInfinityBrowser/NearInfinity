...
public final class Animation extends AbstractStruct implements AddRemovable {
  ...
  public static final String[] FLAGS_ARRAY = { "Not shown", "Is shown", "No shadow", "Not light source",
  ...
  public int read(ByteBuffer buffer, int offset) throws Exception {
    ...
    if (Profile.getEngine() == Profile.Engine.BG2 || Profile.getEngine() == Profile.Engine.IWD2
