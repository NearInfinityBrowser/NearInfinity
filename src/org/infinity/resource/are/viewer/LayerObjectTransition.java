...
public class LayerObjectTransition extends LayerObject {
  public static final String[] FIELD_NAME = { AreResource.ARE_AREA_NORTH, AreResource.ARE_AREA_EAST,
                                              AreResource.ARE_AREA_SOUTH, AreResource.ARE_AREA_WEST, };
    ...
    if (renderer != null) {
      ...
      switch (edge) {
        case ViewerConstants.EDGE_NORTH:
          shapeCoords[0].x = 0;
          shapeCoords[0].y = 0;
          shapeCoords[1].x = mapW;
          shapeCoords[1].y = 0;
          shapeCoords[2].x = mapW;
          shapeCoords[2].y = WIDTH;
          shapeCoords[3].x = 0;
          shapeCoords[3].y = WIDTH;
          break;
        case ViewerConstants.EDGE_EAST:
          shapeCoords[0].x = mapW - WIDTH;
          shapeCoords[0].y = 0;
          shapeCoords[1].x = mapW;
          shapeCoords[1].y = 0;
          shapeCoords[2].x = mapW;
          shapeCoords[2].y = mapH;
          shapeCoords[3].x = mapW - WIDTH;
          shapeCoords[3].y = mapH;
          break;
        case ViewerConstants.EDGE_SOUTH:
          shapeCoords[0].x = 0;
          shapeCoords[0].y = mapH - WIDTH;
          shapeCoords[1].x = mapW;
          shapeCoords[1].y = mapH - WIDTH;
          shapeCoords[2].x = mapW;
          shapeCoords[2].y = mapH;
          shapeCoords[3].x = 0;
          shapeCoords[3].y = mapH;
        ...
        case ViewerConstants.EDGE_WEST:
          shapeCoords[0].x = 0;
          shapeCoords[0].y = 0;
          shapeCoords[1].x = WIDTH;
          shapeCoords[1].y = 0;
          shapeCoords[2].x = WIDTH;
          shapeCoords[2].y = mapH;
          shapeCoords[3].x = 0;
          shapeCoords[3].y = mapH;
          break;
