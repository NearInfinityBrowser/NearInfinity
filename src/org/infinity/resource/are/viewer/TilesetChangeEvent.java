...
public class TilesetChangeEvent extends EventObject {
   ...
   */
  public TilesetChangeEvent(Object source, boolean mapChanged, boolean appearanceChanged, boolean overlayChanged,
  ...
  /**
   * Returns true if the layout of the whole map has been changed (e.g. after loading a new tileset or changing the zoom
   * level).
   */
  ...
  /**
   * Returns true if only the appearance of the map tiles has changed (e.g. after changing lighting conditions or
   * showing a grid).
   */
  ...
  /**
   * Returns true if overlay tiles have been changed (e.g. after setting a different frame in animated overlays).
   */
