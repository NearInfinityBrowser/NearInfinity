...
public class LayerObjectAnimation extends LayerObject {
  ...
  public LayerObjectAnimation(AreResource parent, Animation anim) {
    ...
    try {
      ...
      if (isWBM) {
        ...
        if (cycle < 0) {
          cycle = 0;
        } else if (cycle >= control.cycleCount()) {
  ...
  /**
   * Sets the lighting condition of the animation. Does nothing if the animation is flagged as self-illuminating.
   *
