...
public class LayerProTrap extends BasicLayer<LayerObjectProTrap, AreResource> {
  private static final String AVAILABLE_FMT = "Projectile traps: %d";
  ...
  protected void loadLayer() {
    loadLayerItems(ARE_OFFSET_PROJECTILE_TRAPS, ARE_NUM_PROJECTILE_TRAPS, ProTrap.class,
        p -> new LayerObjectProTrap(parent, p));
  }
