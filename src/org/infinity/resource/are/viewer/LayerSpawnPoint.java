...
public class LayerSpawnPoint extends BasicLayer<LayerObjectSpawnPoint, AreResource> {
  private static final String AVAILABLE_FMT = "Spawn points: %d";
  ...
  protected void loadLayer() {
    loadLayerItems(ARE_OFFSET_SPAWN_POINTS, ARE_NUM_SPAWN_POINTS, SpawnPoint.class,
        p -> new LayerObjectSpawnPoint(parent, p));
  }
