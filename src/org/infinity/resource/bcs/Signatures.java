...
public class Signatures {
  ...
  /**
   * Returns the full set of available function identifiers which can be used to query function signatures.
   */
   ...
   * @param isTrigger Indicates whether function definitions are considered triggers ({@code true}) or actions
   *                  ({@code false}).
  ...
  public static Signatures get(String resource, boolean isTrigger) {
    ...
    if (retVal == null) {
      ...
      try {
        ...
        for (String line : lines) {
          ...
          if (f != null) {
            ...
            set.add(f);
            retVal.functions.put(f.getId(), set);
      ...
      List<String> hardcoded = info
          .getFunctionDefinitions(isTrigger ? Function.FunctionType.TRIGGER : Function.FunctionType.ACTION);
  ...
  public static class Function {
    ...
    /**
     * Default name for the convenience trigger TriggerOverride() derived from artificial signature:
     * NextTriggerObject(O:Target,T:Trigger)
     */
    ...
    public void setName(String name) {
      this.name = (name != null) ? name : "Unknown" + id;
    }
    ...
    /**
     * Returns the parameter entry at the specified position. Throws an {@link IndexOutOfBoundsException} on error.
     */
    ...
    /**
     * Adds the specified parameter entry to the end of the parameter list. Returns the new item position.
     */
    public int addParameter(Parameter p) {
      return insertParameter(getNumParameters(), p);
    }

    /**
     * Inserts a new parameter entry at the specified position to the parameter list. Returns the new item position or
     * -1 on error.
     */
    ...
    /**
     * Returns the number of parameters that define a namespace. The result is independent of whether namespaces are
     * stored separately.
     */
    ...
    @Override
    public int hashCode() {
      return Objects.hash(id, param, type);
    }
    ...
    public boolean equals(Object obj) {
      ...
      return id == other.id && Objects.equals(param, other.param) && type == other.type;
    }
    ...
    public static class Parameter {
      ...
      public void setType(char type) {
        this.type = (type == 0) ? type : Character.toUpperCase(type);
      }
      ...
      /**
       * Returns a list of resource types referenced by the parameter. Returns empty list if no resource type is
       * referenced.
       */
      ...
      /**
       * Returns whether the current string argument has to be splitted from a string parameter. Always returns
       * {@code false} for non-string parameters.
       */
      ...
      /**
       * Returns whether the current string argument is included in a colon-separated string parameter. Always returns
       * {@code false} for non-string parameters.
       */
      ...
      @Override
      public int hashCode() {
        return Objects.hash(colonSeparated, combinedString, resType, type);
      }
      ...
      public boolean equals(Object obj) {
        ...
        return colonSeparated == other.colonSeparated && combinedString == other.combinedString
            && Objects.equals(resType, other.resType) && type == other.type;
      }
      ...
      public String toString(boolean verbose) {
        ...
        if (verbose && resType != null && !resType.isEmpty() && !Character.isLowerCase(resType.charAt(0))) {
          // don't include internal keywords
