...
/**
 * Represents node in the dialog tree that contains states, that not accessible from any other dialog
 *
 * @author Mingun
 */
final class OrphanStates extends StateOwnerItem implements Iterable<StateItem> {
  ...
  public OrphanStates(DlgTreeModel parent) {
    this.parent = parent;
  }

  @Override
  public String toString() {
    return "Orphan states";
  }
