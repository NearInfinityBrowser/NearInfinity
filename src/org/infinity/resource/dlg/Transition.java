...
public final class Transition extends AbstractStruct implements AddRemovable, TreeItemEntry {
  ...
  private static final String[] FLAGS_ARRAY = { "No flags set", "Text associated", "Trigger", "Action",
      "Terminates dialogue", "Journal entry", "Interrupt", "Add unsolved quest", "Add journal note", "Add solved quest",
      "EE: Execute immediate;Attempt to execute non-blocking script actions instantly.", "EE: Clear actions" };
  ...
  @Override
  public DlgResource getParent() {
    return (DlgResource) super.getParent();
  }

  // Flag 0: Transition contains text
  @Override
  public boolean hasAssociatedText() {
    return getFlag().isFlagSet(0);
  }
  ...
  public int read(ByteBuffer buffer, int offset) throws Exception {
    addField(new Flag(buffer, offset, 4, DLG_TRANS_FLAGS, FLAGS_ARRAY));
