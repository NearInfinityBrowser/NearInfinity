...
/**
 * Implementation of opcode 247.
 */
public class Opcode247 extends BaseOpcode {
  ...
  private static String getOpcodeName() {
    switch (Profile.getEngine()) {
      ...
      case IWD2:
      case IWD:
        return "Beltyn's burning blood";
      default:
        return "Attack nearest creature";
    }
  }

  public Opcode247() {
    super(247, getOpcodeName());
  }
