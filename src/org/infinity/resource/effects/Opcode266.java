...
/**
 * Implementation of opcode 266.
 */
public class Opcode266 extends BaseOpcode {
  ...
  private static String getOpcodeName() {
    switch (Profile.getEngine()) {
      ...
      case IWD:
      case IWD2:
        return "Movement rate modifier";
      default:
        return "Remove protection from spell";
    }
  }

  public Opcode266() {
    super(266, getOpcodeName());
  }
