...
/**
 * Implementation of opcode 297.
 */
public class Opcode297 extends BaseOpcode {
  ...
  private static String getOpcodeName() {
    switch (Profile.getEngine()) {
      ...
      case IWD:
        return null;
      case IWD2:
        return "Hide in shadows bonus";
      default:
        return "Immunity to turn undead";
    }
  }

  public Opcode297() {
    super(297, getOpcodeName());
  }
