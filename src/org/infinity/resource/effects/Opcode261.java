...
public class Opcode261 extends BaseOpcode {
  ...
  private static final String[] SPELL_CLASSES = new String[] { "Wizard", "Priest" };
  ...
  private static String getOpcodeName() {
    switch (Profile.getEngine()) {
      ...
      case PST:
        return null;
      case IWD:
        return "Immunity to effect and string";
      case IWD2:
        return "Immunity to effect and resource";
      default:
        return "Restore lost spells";
    }
  }

  public Opcode261() {
    super(261, getOpcodeName());
  }

  @Override
  protected String makeEffectParamsGeneric(Datatype parent, ByteBuffer buffer, int offset, List<StructEntry> list,
      boolean isVersion1) {
    list.add(new DecNumber(buffer, offset, 4, EFFECT_SPELL_LEVEL));
