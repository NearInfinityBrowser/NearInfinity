...
public class Opcode258 extends BaseOpcode {
  ...
  private static final String[] TYPES_IWD = { "Default", "Test and set to 0" };
  ...
  private static String getOpcodeName() {
    switch (Profile.getEngine()) {
      ...
      case IWD:
      case IWD2:
        return "Immunity to specific resource";
      default:
        return "Activate spell sequencer";
    }
  }

  public Opcode258() {
    super(258, getOpcodeName());
  }
