...
public final class QuestsPanel extends JPanel implements ListSelectionListener {
  ...
  private static final class QuestsModel extends AbstractTableModel {
    private static final String[] COLUMNS = { "#", "Quest Name", };

    private final List<Quest> quests;

    QuestsModel(List<Quest> quests) {
      this.quests = quests;
    }
  ...
  private static final class ConditionModel extends AbstractTableModel {
    private static final String[] COLUMNS = { "Variable Name", "Condition", "Value", "Current", };
    ...
    @Override
    public int getColumnCount() {
      return COLUMNS.length - (vars == null ? 1 : 0);
    }
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
      ...
      switch (columnIndex) {
        case 0:
          return cond.var;
        case 1:
          return cond.getHumanizedCondition();
        case 2:
          return cond.value;
        case 3:
          return vars.getInt(cond.var);
      }
      throw new IndexOutOfBoundsException("Invalid column " + columnIndex);
    }
  }
