...
/**
 * This resource is used to declare variables for use in scripting - it is the only way new variables can be added.
 * Variables should be alphabetically ordered (within their appropriate scope section). Globals and Locals work as with
 * other engines, the {@code KAPUTZ} scope acts as the {@code SPRITE_ID_DEAD} scope of the BG series. The
 * {@code var.var} file is located the root folder of the game directory.
 *
