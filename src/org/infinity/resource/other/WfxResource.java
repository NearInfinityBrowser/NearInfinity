...
/**
 * This resource determines variation for playback of wave sounds. A WFX file controls the variation for the the WAV
 * file with the same basename (e.g. {@code mysound.wfx} controls the variation for {@code mysound.wav}).
 * <p>
...
public final class WfxResource extends AbstractStruct implements Resource, HasViewerTabs {
  ...
  private static final String[] FLAGS_ARRAY = { "No flags set", "Cutscene audio", "Alternate SR curve",
  ...
  public int read(ByteBuffer buffer, int offset) throws Exception {
    ...
    addField(new Flag(buffer, offset + 12, 4, WFX_FLAGS, FLAGS_ARRAY));
