 ...
 * @author Mingun
 */
public class ResourceListModel extends AbstractListModel<ResourceEntry> implements ComboBoxModel<ResourceEntry> {
  private final ArrayList<ResourceEntry> resources = new ArrayList<>();

  private ResourceEntry selected;

  /**
   * Initializes this model with all resources of specified types. Internal list sorted according to resource names.
   *
  ...
  public void setSelectedItem(Object anItem) {
    selected = (ResourceEntry) anItem;
  }

  @Override
  public ResourceEntry getSelectedItem() {
    return selected;
  }
   ...
   * @return an {@code int} representing the index position, where 0 is the first position. Returns -1 if this list does
