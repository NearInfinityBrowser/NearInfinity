...
/**
 * The interface implemented by objects which can be serialized in the self-natural internal format. As a rule, the same
 * objects implements the {@link Readable} interface by means of which they can be read back from the input stream.
 *
