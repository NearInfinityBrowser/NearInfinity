...
public final class IDSRefChecker extends TypeChecker implements ActionListener, Runnable
{
  ...
  private void search(ResourceEntry entry, AbstractStruct struct)
  {
    for (StructEntry e : struct.getFlatList()) {
      if (e instanceof IdsBitmap) {
        ...
        if (ref.toString().startsWith("Unknown - ") && ref.getValue() != 0) {//FIXME: remove check of striong
