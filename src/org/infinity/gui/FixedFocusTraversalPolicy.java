...
public class FixedFocusTraversalPolicy extends FocusTraversalPolicy {
  ...
  /**
   * Constructs a customized FocusTraversalPolicy class that uses a fixed list of components it will focus on.
   *
   ...
   *
   * @param list             The list of components to focus.
   * @param defaultComponent An optional default component. Defaults to the first component in {@code list} if not
   *                         specified.
   */
  ...
  /**
   * Sets the default component to focus. The component has to be in the list of components specified either in the
   * constructor or in {@link #setComponents(Component[])}.
   */
