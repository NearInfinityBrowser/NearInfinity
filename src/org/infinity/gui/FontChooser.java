...
public class FontChooser extends JComponent {
  ...
  /**
   * Constructs a {@code FontChooser} object using the given font size array.
   *
   ...
   *
   * @return the style of the selected font. {@code Font.PLAIN}, {@code Font.BOLD}, {@code Font.ITALIC},
   ...
   *
   * @param style the size of the selected font. {@code Font.PLAIN}, {@code Font.BOLD}, {@code Font.ITALIC}, or
   *              {@code Font.BOLD|Font.ITALIC}.
   *
   * @see java.awt.Font#PLAIN
   * @see java.awt.Font#BOLD
  ...
  protected JDialog createDialog(Component parent) {
    ...
    // XXX: work around to ensure selected list entry is within visible area
    getFontFamilyList().ensureIndexIsVisible(getFontFamilyList().getSelectedIndex());
