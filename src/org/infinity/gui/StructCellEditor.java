...
//-------------------------- INNER CLASSES --------------------------
  ...
  protected class StructEditorDelegate implements ActionListener, ItemListener {
    ...
    /**
     * Returns {@code true} if {@code anEvent} is <b>not</b> a {@code MouseEvent}. Otherwise, it returns {@code true} if
     * the necessary number of clicks have occurred, and returns {@code false} otherwise.
     *
