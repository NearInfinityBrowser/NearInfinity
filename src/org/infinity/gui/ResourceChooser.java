...
public class ResourceChooser extends JComponent implements ActionListener {
  ...
  private static final Dimension DEFAULT_DIMENSION = new Dimension(200, 250);
  ...
  /**
   * Constructs a new Resource Chooser component. The first available resource type will be preselected.
   */
  ...
  /**
   * Returns the filename of the selected resource from the list. Returns {@code null} if no item has been selected.
   *
  ...
  private class ResourceDialog extends JDialog implements ActionListener {
    ...
    private void init() {
      ...
      GridBagConstraints gbc = new GridBagConstraints();
      gbc = ViewerUtil.setGBC(gbc, 0, 0, 1, 1, 1.0, 1.0, GridBagConstraints.LINE_START, GridBagConstraints.HORIZONTAL,
          new Insets(0, 0, 0, 0), 0, 0);
      ...
      gbc = ViewerUtil.setGBC(gbc, 3, 0, 1, 1, 1.0, 1.0, GridBagConstraints.LINE_START, GridBagConstraints.HORIZONTAL,
          new Insets(0, 0, 0, 0), 0, 0);
      panelButtons.add(new JPanel(), gbc);
