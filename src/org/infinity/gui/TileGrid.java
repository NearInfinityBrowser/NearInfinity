...
/**
 * Implements a 2D grid of tiles (image blocks of fixed size) featuring resizable rows and columns and several visual
 * options.
 */
public class TileGrid extends JComponent {
  ...
  /**
   * Returns the number of tiles displayed in the component (NOT necessarily equal to the number of images assigned to
   * this component!).
   *
   ...
   *
   * @param image The image to look for
   * @return A point structure, containing the row (height) and column (width) of the matching image or null otherwise.
   */
