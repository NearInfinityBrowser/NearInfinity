...
/**
 * A slightly improved version of {@link SimpleDataProvider} which allows to change size of the data buffer with the
 * {@link #setDataLength(int)} method.
 */
public class VariableDataProvider implements IDataProvider {
  ...
  /**
   * Resizes the current data buffer to the specified length in bytes. Old data will be retained as best as possible.
   *
