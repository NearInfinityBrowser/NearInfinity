...
public interface InlineEditable extends StructEntry {
  ...
  /**
   * Returns the editing component that is used for editing a value within the table cell. This method is called
   * whenever the editor is activated.
   * <p>
   * <b>Note:</b> For performance reasons the returned component should only be created once and reused afterwards.
   */
  default JComponent getEditor() {
    return DEFAULT_EDITOR;
  }

  /** This method is called to return the edited data in a format supported by the {@code InlineEditable} object. */
  default Object getEditorValue() {
    return DEFAULT_EDITOR.getText();
  }

  /** This method is called to initialize the editor with the specified data. */
  default void setEditorValue(Object data) {
    DEFAULT_EDITOR.setText((data != null) ? data.toString() : "");
  }
}
