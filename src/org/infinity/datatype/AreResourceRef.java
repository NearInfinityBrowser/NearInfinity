...
public final class AreResourceRef extends ResourceRef {
  ...
  public AreResourceRef(ByteBuffer buffer, int offset, String name, AreResource are) {
    super(buffer, offset, name, "WAV");
    ResourceEntry res = ResourceFactory
...
//     }
  ...
  public boolean isLegalEntry(ResourceEntry entry) {
    ...
    if (!(entry instanceof BIFFResourceEntry) || entry.hasOverride()) {
      return true;
    }
