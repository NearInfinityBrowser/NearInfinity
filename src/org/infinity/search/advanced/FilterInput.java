...
public class FilterInput extends ChildFrame {
  ...
  private JButton bStructureAdd;
  private JButton bStructureRemove;
  private JButton bStructureEdit;
  ...
  private JFormattedTextField ftfValueInputMin;
  private JFormattedTextField ftfValueInputMax;
  ...
  private JButton bInputReset;
  private JButton bInputApply;
  private JButton bInputClose;
  ...
  /**
   * Associates a SearchOptions instance with the dialog. Specify {@code null} to create a new SearchOptions entry. Use
   * parameter {@code isNew} to override the accept button label ("Add" or "Apply").
   */
  ...
  private void init() {
    ...
    c = ViewerUtil.setGBC(c, 0, 0, 1, 1, 1, 1, GridBagConstraints.FIRST_LINE_START, GridBagConstraints.BOTH,
        new Insets(0, 0, 0, 0), 0, 0);
    pFilterMain.add(pStructure, c);
    c = ViewerUtil.setGBC(c, 0, 1, 1, 1, 1, 0, GridBagConstraints.FIRST_LINE_START, GridBagConstraints.HORIZONTAL,
        new Insets(8, 0, 0, 0), 0, 0);
    pFilterMain.add(pField, c);
    c = ViewerUtil.setGBC(c, 0, 2, 1, 1, 1, 0, GridBagConstraints.FIRST_LINE_START, GridBagConstraints.HORIZONTAL,
        new Insets(8, 0, 0, 0), 0, 0);
    pFilterMain.add(pValue, c);
    c = ViewerUtil.setGBC(c, 0, 3, 1, 1, 1, 0, GridBagConstraints.FIRST_LINE_START, GridBagConstraints.NONE,
  ...
  private JPanel initStructureLevel() {
    ...
    scrollTree
        .setPreferredSize(new Dimension(renderer.getPreferredSize().width, renderer.getPreferredSize().height * 4));
    ...
    c = ViewerUtil.setGBC(c, 0, 0, 1, 1, 1, 0, GridBagConstraints.LINE_START, GridBagConstraints.NONE,
        new Insets(0, 0, 0, 0), 0, 0);
  ...
  private JPanel initFieldInput() {
    ...
    DefaultComboBoxModel<DataString<SearchOptions.FieldMode>> modelFieldType = new DefaultComboBoxModel<DataString<SearchOptions.FieldMode>>() {
      {
        addElement(DataString.with("Name", SearchOptions.FieldMode.BY_NAME, "%s"));
        addElement(DataString.with("Relative Offset", SearchOptions.FieldMode.BY_RELATIVE_OFFSET, "%s"));
        addElement(DataString.with("Absolute Offset", SearchOptions.FieldMode.BY_ABSOLUTE_OFFSET, "%s"));
      }
    };
    ...
    ftfFieldOffsetInput = new JFormattedTextField(
        new NumberFormatterEx(NumberFormatterEx.NumberFormat.HEXADECIMAL, 0L, Integer.MAX_VALUE, 0L));
    ftfFieldOffsetInput
        .setToolTipText("Supported notations: decimal, hexadecimal (requires prefix \"0x\" or suffix \"h\")");
    ...
    c = ViewerUtil.setGBC(c, 0, 0, 1, 1, 0, 0, GridBagConstraints.LINE_START, GridBagConstraints.HORIZONTAL,
        new Insets(0, 0, 0, 0), 0, 0);
    pFieldOffset.add(lFieldOffset, c);
    c = ViewerUtil.setGBC(c, 0, 1, 1, 1, 1, 0, GridBagConstraints.LINE_START, GridBagConstraints.HORIZONTAL,
        new Insets(4, 0, 0, 0), 0, 0);
    pFieldOffset.add(ftfFieldOffsetInput, c);
    c = ViewerUtil.setGBC(c, 0, 2, 1, 1, 1, 1, GridBagConstraints.LINE_START, GridBagConstraints.BOTH,
        new Insets(0, 0, 0, 0), 0, 0);
  ...
  private JPanel initValueInput() {
    ...
    DefaultComboBoxModel<DataString<SearchOptions.ValueType>> modelValueType = new DefaultComboBoxModel<DataString<SearchOptions.ValueType>>() {
      {
    ...
    ftfValueInputMin = new JFormattedTextField(
        new NumberFormatterEx(NumberFormatterEx.NumberFormat.DECIMAL, -0xffffffffL, 0xffffffffL, 0L));
    ...
    ftfValueInputMax = new JFormattedTextField(
        new NumberFormatterEx(NumberFormatterEx.NumberFormat.DECIMAL, -0xffffffffL, 0xffffffffL, 32767));
    ...
    c = ViewerUtil.setGBC(c, 0, 1, 3, 1, 0, 0, GridBagConstraints.LINE_START, GridBagConstraints.HORIZONTAL,
        new Insets(8, 0, 0, 0), 0, 0);
    ...
    // bitfield input
    final String[] flagsDesc = { "Bit 0", "Bit 1", "Bit 2", "Bit 3", "Bit 4", "Bit 5", "Bit 6", "Bit 7", "Bit 8",
        "Bit 9", "Bit 10", "Bit 11", "Bit 12", "Bit 13", "Bit 14", "Bit 15", "Bit 16", "Bit 17", "Bit 18", "Bit 19",
        "Bit 20", "Bit 21", "Bit 22", "Bit 23", "Bit 24", "Bit 25", "Bit 26", "Bit 27", "Bit 28", "Bit 29", "Bit 30",
        "Bit 31" };
    bpwValueBitfield = new ButtonPopupWindow("Set options...", new FlagsPanel(4, flagsDesc));

    JLabel lValueBitfieldMode = new JLabel("Mode:");
    DefaultComboBoxModel<DataString<SearchOptions.BitFieldMode>> modelValueBitfieldMode = new DefaultComboBoxModel<DataString<SearchOptions.BitFieldMode>>() {
      {
    ...
    c = ViewerUtil.setGBC(c, 1, 1, 1, 1, 1, 0, GridBagConstraints.LINE_START, GridBagConstraints.HORIZONTAL,
    ...
    c = ViewerUtil.setGBC(c, 0, 1, 2, 1, 0, 0, GridBagConstraints.LINE_START, GridBagConstraints.HORIZONTAL,
        new Insets(8, 8, 0, 8), 0, 0);
    pValue.add(lValue, c);
    c = ViewerUtil.setGBC(c, 0, 2, 2, 1, 1, 0, GridBagConstraints.LINE_START, GridBagConstraints.HORIZONTAL,
  ...
  /**
   * Returns a complete list of resource types supported by the current game. {@code addEmpty} indicates whether to add
   * an empty entry at the first list position.
   */
  ...
  private void importOptions(SearchOptions so) {
    ...
    // field input
    {
      DefaultComboBoxModel<DataString<SearchOptions.FieldMode>> model = (DefaultComboBoxModel<DataString<SearchOptions.FieldMode>>) cbFieldType
          .getModel();
      int idx = 0;
    ...
    // value input
    {
      DefaultComboBoxModel<DataString<SearchOptions.ValueType>> modelValue = (DefaultComboBoxModel<DataString<SearchOptions.ValueType>>) cbValueType
          .getModel();
      int idx = 0;
      ...
      DefaultComboBoxModel<DataString<SearchOptions.BitFieldMode>> modelMode = (DefaultComboBoxModel<DataString<SearchOptions.BitFieldMode>>) cbValueBitfieldMode
          .getModel();
      idx = 0;
      for (int i = 0; i < modelValue.getSize(); i++) {
  ...
  private void exportOptions(SearchOptions so) {
    ...
    // value input
    {
      ...
      if (os != null) {
        ...
        switch (type) {
          case TEXT:
            so.setValueText(tfValueStringInput.getText(), cbValueStringCase.isSelected(),
                cbValueStringRegex.isSelected());
            break;
          case NUMBER: {
            int min = (int) ((NumberFormatterEx) ftfValueInputMin.getFormatter()).getNumericValue();
            int max = cbValueNumberRange.isSelected()
                ? (int) ((NumberFormatterEx) ftfValueInputMax.getFormatter()).getNumericValue()
                : min;
          ...
          case BITFIELD: {
            FlagsPanel fp = (FlagsPanel) bpwValueBitfield.getContent();
            DataString<SearchOptions.BitFieldMode> osMode = cbValueBitfieldMode.getModel()
                .getElementAt(cbValueBitfieldMode.getSelectedIndex());
  ...
  private void clearTreeNodes(JTree tree) {
    if (tree != null) {
      if (tree.getModel() instanceof DefaultTreeModel && tree.getModel().getRoot() instanceof MutableTreeNode) {
        DefaultTreeModel model = (DefaultTreeModel) tree.getModel();
    ...
    if (tree != null) {
      ...
      if (path != null) {
        ...
        if (node instanceof MutableTreeNode && ((MutableTreeNode) node).getParent() != null) {
          if (!prompt || JOptionPane.showConfirmDialog(FilterInput.this,
              String.format("Remove substructure \"%s\"?", node.toString()), "Confirm removal",
  ...
  private class Listeners implements ActionListener, TreeWillExpandListener, TreeSelectionListener, MouseListener,
    ...
    public void keyPressed(KeyEvent event) {
      if (event.getSource() == treeStructure) {
        ...
        long inc = (event.getModifiersEx() & InputEvent.CTRL_DOWN_MASK) == 0 ? 1L : 10L;
