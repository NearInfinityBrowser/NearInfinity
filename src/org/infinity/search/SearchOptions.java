...
public class SearchOptions {
  ...
  // Exception 1: Names starting with an underscore (_) are fetched by offset, index specifies the (relative) offset
  // value
  ...
  /**
   * Adds the specified name/value pair into the list. If {@code value} is {@code null}, an existing entry of the
   * specified name will be removed.
   *
   * @param name  The name of the option to add.
   * @param value The value of the option to add. Special: If {@code value} is {@code null}, an existing option of the
   *              same name will be removed.
   * @return The previous value of the option, or {@code null} if no previous option of the specified name exists.
   */
  ...
  public static final class Utils {
    ...
    public static boolean matchNumber(StructEntry number, Object value) {
      if (number != null && value != null) {
        ...
        if (value instanceof Integer) {
          n1 = n2 = (Integer) value;
        } else if (value instanceof Couple<?, ?> && ((Couple<?, ?>) value).getValue0() instanceof Integer
      ...
      if (struct != null && match != null && match instanceof Couple<?, ?>
        ...
        if (!fieldName.isEmpty() && value != null) {
          ...
          if (structList != null && !structList.isEmpty()) {
            for (StructEntry entry : structList) {
              if (entry != null) {
