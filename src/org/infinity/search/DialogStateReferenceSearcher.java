...
/**
 * Performs search of the specified dialogue state in other dialogues (including dialogue in which state defined).
 */
public final class DialogStateReferenceSearcher extends AbstractReferenceSearcher {
  ...
  /**
   * Creates finder that searches dialogue state (NPC reply) in the other dialogues. Performs search only in the
   * {@link DlgResource DLG} files.
   *
