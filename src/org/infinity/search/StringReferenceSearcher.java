...
public final class StringReferenceSearcher extends AbstractReferenceSearcher {
  /**
   * Regular expression, used to the find string references in the {@link PlainTextResource text resources}. Expression
   * consists from three parts:
   * <ul>
  ...
  /**
   * Recursively searches references to string {@link #searchvalue} in all fields of specified structure and it's
   * substructures.
   *
