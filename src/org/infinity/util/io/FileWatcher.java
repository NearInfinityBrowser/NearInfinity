...
/**
 * Continuously monitors one or more registered paths for content changes and notifies registered listeners about the
 * changes. TODO: watched directories are locked on Windows and can't be properly deleted - find workaround
 */
public class FileWatcher implements Runnable {
  ...
  /**
   * Adds the specified filewatch listener to receive notifications about file changes in registered directories.
   *
  ...
  /**
   * Removes the specified filewatch listener so that it no longer receives events from this FileWatcher instance.
   *
   * @param l the filewatch listener
   */
  ...
  /**
   * Adds the specified directory path and optional subdirectories to the watcher list with enabled notifications for
   * create and delete operations. Does nothing if the path has already been registered.
   */
  ...
  /**
   * Adds the specified directory path and optional subdirectories to the watcher list for a selected set of
   * notification types. Does nothing if the path has already been registered.
   *
  ...
  /**
   * Removes the specified directory path and optional subdirectories from the watcher list. Does nothing if the
   * specified directory path is not registered.
   */
