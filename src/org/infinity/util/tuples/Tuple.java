...
public abstract class Tuple implements Iterable<Object>, Comparable<Tuple> {
  public static final Function<List<Object>, String> FMT_DEFAULT = List::toString;
   ...
   * <p>
   * It takes a list of {@code Objects} which represent the values assigned to the tuple and returns a textual
   ...
   * representation of the values.
   *
   * @param formatter the {@code Function} to generate the return value of the {@link #toString()} method. Specify
   *                  {@code null} to revert to the default function.
   */
  ...
  /**
   * Returns {@code true} if this tuple contains the specified element. More formally, returns {@code true} if and only
   * if this tuple contains at least one element {@code e} such that {@code (o==null ? e==null : o.equals(e))}.
   *
  ...
  /**
   * Returns the index of the first occurrence of the specified element in this tuple, or -1 if this tuple does not
   ...
   * @return the index of the first occurrence of the specified element in this tuple, or -1 if this tuple does not
   *         contain the element.
   */
  ...
  /**
   * Returns the index of the last occurrence of the specified element in this tuple, or -1 if this tuple does not
   * contain the element. More formally, returns the highest index {@code i} such that
   * {@code (o==null ? get(i)==null : o.equals(get(i)))}, or -1 if there is no such index.
   *
   * @param o element to search for.
   * @return the index of the last occurrence of the specified element in this tuple, or -1 if this tuple does not
   *         contain the element.
   */
