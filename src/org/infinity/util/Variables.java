...
public class Variables {
  ...
  /**
   * Appends specified variable to the variable set. If variable with such {@link AbstractVariable#VAR_NAME name}
  ...
  /**
   * Returns integer variable value with specified name. If such variable is not exist or not storing integer value,
   * {@code 0} is returned.
   *
