...
public class IdsMap {
  ...
  /**
   * Attempts to find the entry containing the specified symbol. Symbol will be compared case-sensitive except for
   * triggers, actions and objects.
   *
  ...
  private void extractIDS(String line) {
    ...
    if (!istr.isEmpty()) {
      ...
      if (!vstr.isEmpty()) {
        ...
        symbolMap.put(normalizedString(vstr), key);
      }
    }
  }
